...
run test_message_service src/services/message_service.c src/services/message_file_codec.c src/services/sms_picture_codec.c src/services/sms_deliver_codec.c src/services/sms_vvm_filter.c src/storage/storage_lfs.c third_party/littlefs/lfs.c third_party/littlefs/lfs_util.c -I third_party/littlefs -DLFS_NO_MALLOC -DLFS_NO_DEBUG -DLFS_NO_WARN -DLFS_NO_ERROR
