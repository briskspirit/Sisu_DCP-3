...
Settings and phone-local records use a CRC-protected two-slot journal in the
last 128 KiB of internal flash. Phonebook entries and SMS bodies remain
modem-backed and are read lazily.
